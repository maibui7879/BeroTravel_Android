...
public class PlaceFragment extends Fragment {
    ...
    private void checkScheduleAndAdd() {
        ...
        com.example.berotravel20.network.TokenManager tokenManager = new com.example.berotravel20.network.TokenManager(
                getContext());
        if (tokenManager.getToken() == null) {
            startActivity(
                    new android.content.Intent(getContext(), com.example.berotravel20.ui.auth.AuthActivity.class));
    ...
    private void showCreateTripDialogWithDates() {
        ...
        btnCreate.setOnClickListener(v -> {
            ...
            createJourneyAndAddPlace(selectedLoc, start, end);
            dialog.dismiss();
        });
    ...
    private void createJourneyAndAddPlace(String location, String start, String end) {
        com.example.berotravel20.models.AddPlaceRequest request = new com.example.berotravel20.models.AddPlaceRequest(
                currentPlace._id, location, convertDate(start), convertDate(end));
